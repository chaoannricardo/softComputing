...
namespace R08546036_SHChaoAss04
{
    public partial class MainForm : Form
    {
        ...
        private void btnCreateUnaryFuzzySet_Click(object sender, EventArgs e)
        {
            if (!(theTree.SelectedNode.Tag is FuzzySet)) return; // return if not fuzzy set
        ...
        private void labLeftFS_Click_Click(object sender, EventArgs e)
        {
            if (theTree.SelectedNode.Tag is FuzzySet)
            {
                labLeftFS.Tag = theTree.SelectedNode.Tag; // add fuzzy set's tag to label
