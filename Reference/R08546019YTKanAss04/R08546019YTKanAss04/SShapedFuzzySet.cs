...
{
    class SShapedFuzzySet : FuzzySet  //繼承
    {
        // define properties
        ...
        public double Right
        {
            ...
            {
                //guarding
                if (value >= parameterValues[0] && value <= theUniverse.UpperBound) parameterValues[1] = value;
                if (showSeries)
                {
                    UpdateSeriesPoints();
                }
        ...
        // constructor
        public SShapedFuzzySet(Universe v) : base(v)  //base：父親類別  //base()：呼叫父親的建構函式  //v：區域變數
        {
