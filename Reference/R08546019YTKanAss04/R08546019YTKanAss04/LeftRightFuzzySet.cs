...
namespace R08546019YTKanAss04
{
    class LeftRightFuzzySet : FuzzySet  //繼承
    {
        ...
        public double Center
        {
            ...
            {
                //guarding
                if (value >= theUniverse.LowerBound && value <= theUniverse.UpperBound) parameterValues[0] = value;
                if (showSeries)
                {
                    UpdateSeriesPoints();
                }
        ...
        public double LeftParameter
        {
            ...
            {
                //guarding
                if (value > 0) parameterValues[1] = value;
                if (showSeries)
                {
                    UpdateSeriesPoints();
                }
        ...
        public double RightParameter
        {
            ...
            {
                //guarding
                if (value > 0) parameterValues[2] = value;
                if (showSeries)
                {
                    UpdateSeriesPoints();
                }
